    ...
    return (
        <>
            <div className="main-page">
                <Head>
                    <title>S7NS Coinflip</title>
                    <meta property="og:title" content="S7NS Coinflip" key="title" />
                </Head>
                <Header
                    balance={solBalance}
                    wallet={wallet}
                                ...
                                <>
                                    <div className="flip-box">
                                        ...
                                        <div className="bet-container">
                                            <p className="bet-title">WES7NNER</p>
                                            <div className="bet-middle-content">
                                                <div className="bet-selecte">
                                                    <div className={`coin-box`} onClick={() => setIsBet(true)}>
                                                        {/* eslint-disable-next-line */}
                                                        {/* <img src="/img/head-1.png" alt=""/> */}
                                                        <video autoPlay loop muted style={{ width: '300px', height: '300px' }}>
                                                            <source src="/img/head1.mp4" />
                                                        </video>
                                                    ...
                                                    <div className={`coin-box`} onClick={() => setIsBet(false)}>
                                                        {/* eslint-disable-next-line */}
                                                        {/* <img src="/img/tail-1.png" alt=""/> */}
                                                        <video autoPlay loop muted style={{ width: '300px', height: '300px' }}>
                                                            <source src="img/tail.mov" />
                                                        </video >
                                                        <p className={`${!isBet ? "text-green" : "text-purple"}`}>
                                                            TAILS
                                                        </p>
